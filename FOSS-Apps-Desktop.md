...
# List of FOSS Apps for Desktop
This page contains the list of FOSS apps for Desktop. Halaman ini berisi daftar aplikasi FOSS untuk Desktop yang diurutkan berdasarkan abjad dan kategori aplikasinya.
...
> **Descriptions:**
> 
> α means Alpha Release.
> 
> β means Beta Release.
> 
> S means Stable Release.
> 
> X means The development of the app is discontinued.
> 
> C means The development of the app is still continue.
>
> NB means Nightly Build
>
> RC means Release Candidate
>
> **Note: The version number in the app will be updated once a month**
______________________________________
## 2D Animation
No | App(s) Name | Platform(s) | License | Description
--- | --- | --- | --- | ---
...
02 | [ArcThemAll!](http://arcthemall.sourceforge.net/) | `Windows` | GNU GPL | X {5.1 S} (Last update: 26/10/2013)
...
02 | [Gnumeric](http://www.gnumeric.org/) | `*BSD, Linux` | GNU GPLv2 or GNU GPLv3 | C {1.12.44 S}
...
02 | [Trelby](https://www.trelby.org/) | `Linux, Windows` | GNU GPLv2 | X {2.2 S} (Last update: 26/09/2012)
...
05 | [Transmission](https://transmissionbt.com/) | `*BSD, Linux, MacOS, Windows` | GNU GPLv2 or GNU GPLv3 | C {2.94 S}
...
02 | [MPC-HC](https://mpc-hc.org/) | `Windows` | GNU GPLv3 | X {1.7.13 S} (Last update: 16/07/2017)
